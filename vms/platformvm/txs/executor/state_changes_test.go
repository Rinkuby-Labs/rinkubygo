...
func TestAdvanceTimeTo_UpdateL1Validators(t *testing.T) {
	...
	var (
		...
		l1ValidatorToEvict0 = newL1Validator(3 * units.NanoRink) // lasts 3 seconds
		l1ValidatorToEvict1 = newL1Validator(3 * units.NanoRink) // lasts 3 seconds
		l1ValidatorToKeep   = newL1Validator(units.Rink)
